...
class LoginFormAuthenticator extends AbstractFormLoginAuthenticator
{
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        $user = $this->entityManager->getRepository(Users::class)->findOneBy(['user_pseudo' => $credentials['user_pseudo']]);
    ...
    {
        //throw new CustomUserMessageAuthenticationException($credentials['user_password'].' - '.$user->getUserPassword());
